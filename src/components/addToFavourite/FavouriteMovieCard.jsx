...
const FavouriteMovieCard = ({ movie, onDragStart, onDragEnd }) => {
  ...
  return (
    <>
      <div
        className="flex items-center border-2 bg-gradient-to-r from-orange-200 to-pink-200 border-gray-300  hover:shadow-lg hover:scale-103 shadow-gray-400 rounded-lg p-2 m-4 transition-transform duration-300 cursor-move"
        draggable
